                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input name="<?=$produit["id"]?>" id="checkbox-table-search-<?=$produit["id"]?>"
                                        type="checkbox"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2 product-checkbox">
                                    <label for="checkbox-table-search-<?=$produit["id"]?>"
                            ...
                            <td class="px-6 py-4">
                                <img src="<?=$produit["image"]?>" alt="photo de<?=$produit["reference_produit"]?>"
                                    class="w-8 h-8">
                            </td>
