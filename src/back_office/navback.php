<nav class="bg-gray-200 max-w-1/4 p-4 flex flex-col">
  ...
  <ul class="flex flex-col gap-2 mt-4">
    ...
    <li>
      <a href="products.php" class="block py-2 px-4 bg-white border-b border-gray-300 hover:bg-gray-100">Gestion commerciale</a>
    </li>
    <li class="relative">
      <a href="javascript:void(0)" class="flex items-center justify-between block py-2 px-4 bg-white border-b border-gray-300 hover:bg-gray-100" onclick="toggleDropdown('logistique-dropdown', this)">
        <span>Logistique</span>
        <svg class="w-4 h-4 transition-transform duration-200" id="dropdown-arrow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <li>
      <a href="comptabilite.php" class="block py-2 px-4 bg-white border-b border-gray-300 hover:bg-gray-100">Comptabilité</a>
    </li>
    <li>
      <a href="userlist.php" class="block py-2 px-4 bg-white border-b border-gray-300 hover:bg-gray-100">Gestion des utilisateurs</a>
    </li>
    <li>
