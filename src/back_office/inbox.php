        ...
        <main class="flex w-full h-full shadow-lg rounded-3xl">
            ...
            <section class="flex flex-col pt-3 w-4/12 bg-gray-50 h-full overflow-y-scroll">
                ...
                <ul class="mt-6" id="message-list">
                    <li class="py-5 border-b px-3 transition hover:bg-indigo-100" data-message="message-1">
                        <!-- message 1 -->
                        <a href="#" class="flex justify-between items-center">
                            <h3 class="text-lg font-semibold">Akhil Gautam</h3>
                            <!-- nom de l'utilisateur ayant envoyé le msg -->
            ...
            <section class="w-6/12 bg-gray-200 p-8 rounded-r-3xl overflow-y-scroll">
                <!-- ici les messages cachés sur le côté en JS, le code se répète par rapport au dessus et affiche le contenu du mail -->
