        ...
        <?php }else { ?>
            ...
            <tr class="bg-white border-b hover:bg-gray-50">
                ...
                <td class="flex items-center px-6 py-4">
                    <a href="edit_product.php?id=<?=$produit["id"]?>" class="font-medium text-blue-600 hover:underline flex items-center space-x-1">
                    ...
                    <a href="deleteProduct.php?id=<?=$produit["id"]?>" class="font-medium text-red-600 hover:underline flex items-center space-x-1 ms-4">
